...
Label(root, text = 'Me', font = 'arial 15 bold').pack(side = BOTTOM)


pass_label = Label(root, text = 'Password Length', font = 'arial 10 bold').pack()
pass_len = IntVar()
length = Spinbox(root, from_ = 8, to_ = 64, textvariable = pass_len, width = 15).pack()
...
def Generator():
    ...
    for new_variable in range (pass_len.get() - 4):
